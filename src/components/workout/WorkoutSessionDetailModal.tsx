...
import { Timer, Dumbbell, Trash2, Play, Award } from 'lucide-react';
                ...
                >
                  ...
                  <div className="p-3 bg-slate-900/60 border-b border-slate-800 flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      <div className="w-9 h-9 rounded-xl bg-slate-950 border border-slate-800 overflow-hidden flex items-center justify-center text-xs font-bold text-slate-400">
                        {ex.exercisePhotoUrl ? (
                      ...
                      <div>
                        <h5 className="text-xs sm:text-sm font-bold text-slate-100 leading-tight">
                          {ex.exerciseName}
                        </h5>
                    ...
                    <span className="text-xs font-mono-numbers font-bold text-emerald-400 bg-emerald-950/40 px-2 py-0.5 rounded border border-emerald-500/20">
